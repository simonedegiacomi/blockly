...
Blockly.Msg.SENSOR_FORCE = 'force sensor';
Blockly.Msg.SENSOR_MOTOR = Blockly.Msg.MOTOR;
...
Blockly.Msg.NAO_JOINT_LEFTSHOULDERPITCH = 'left shoulder pitch';
Blockly.Msg.NAO_JOINT_LEFTSHOULDERROLL = 'left shoulder roll';
Blockly.Msg.NAO_JOINT_LEFTELBOWYAW = 'left elbow yaw';
Blockly.Msg.NAO_JOINT_LEFTELBOWROLL = 'left elbow roll';
Blockly.Msg.NAO_JOINT_LEFTWRISTYAW = 'left wrist yaw';
Blockly.Msg.NAO_JOINT_LEFTHAND = 'left hand';
Blockly.Msg.NAO_JOINT_LEFTHIPYAWPITCH = 'left hip yaw pitch';
Blockly.Msg.NAO_JOINT_LEFTHIPROLL = 'left hip roll';
Blockly.Msg.NAO_JOINT_LEFTHIPPITCH = 'left hip pitch';
Blockly.Msg.NAO_JOINT_LEFTKNEEPITCH = 'left knee pitch';
Blockly.Msg.NAO_JOINT_LEFTANKLEPITCH = 'left ankle pitch';
Blockly.Msg.NAO_JOINT_LEFTANKLEROLL = 'left ankle roll';
Blockly.Msg.NAO_JOINT_RIGHTSHOULDERPITCH = 'right shoulder pitch';
Blockly.Msg.NAO_JOINT_RIGHTSHOULDERROLL = 'right shoulder roll';
Blockly.Msg.NAO_JOINT_RIGHTELBOWYAW = 'right elbow yaw';
Blockly.Msg.NAO_JOINT_RIGHTELBOWROLL = 'right elbow roll';
Blockly.Msg.NAO_JOINT_RIGHTWRISTYAW = 'right wrist yaw';
Blockly.Msg.NAO_JOINT_RIGHTHAND = 'right hand';
Blockly.Msg.NAO_JOINT_RIGHTHIPYAWPITCH = 'right hip yaw pitch';
Blockly.Msg.NAO_JOINT_RIGHTHIPROLL = 'right hip roll';
Blockly.Msg.NAO_JOINT_RIGHTHIPPITCH = 'right hip pitch';
Blockly.Msg.NAO_JOINT_RIGHTKNEEPITCH = 'right knee pitch';
Blockly.Msg.NAO_JOINT_RIGHTANKLEPITCH = 'right ankle pitch';
Blockly.Msg.NAO_JOINT_RIGHTANKLEROLL = 'right ankle roll';
...
Blockly.Msg.FORCE_VALUE_GETSAMPLE_TOOLTIP = 'Gets the current amount of force.';
